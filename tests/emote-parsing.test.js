// Tests for src/chat/emote-parsing.js - the pure parsing core of the chat
// pipeline. Node's built-in runner (`npm test`), no deps, no webview. A wrong
// offset or tier here renders every message wrong, and being pure these are
